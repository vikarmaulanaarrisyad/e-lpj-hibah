    ...
    <div className="min-h-screen bg-[#0F172A] text-slate-100 p-4 sm:p-6 lg:p-10">
      ...
      <main className="max-w-7xl mx-auto mt-8 space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          ...
          {/* Card 8: Dokumentasi Kegiatan & Foto Fisik */}
          <Link
            href="/user/dokumentasi"
            className="group card-hover-lift p-5 sm:p-6 bg-gradient-to-br from-slate-900 to-violet-950/40 hover:to-violet-900/40 border border-slate-800 hover:border-violet-600/70 rounded-2xl shadow-xl flex flex-col justify-between gap-4"
          >
            <div>
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-xl bg-violet-950/70 border border-violet-700/50 text-violet-300 flex items-center justify-center shrink-0 shadow-glow group-hover:scale-110 group-hover:rotate-1 transition-transform duration-300">
                  <Camera className="w-6 h-6 text-violet-300" />
                </div>
                <span className="text-xs px-2 py-0.5 rounded bg-violet-950 border border-violet-700/60 text-violet-300 font-semibold shadow-xs">
                  Foto F4
                </span>
              </div>
              <h3 className="text-base font-bold text-white group-hover:text-violet-300 transition-colors mt-4">
                Dokumentasi Kegiatan
              </h3>
              <p className="text-xs text-slate-400 mt-1.5 leading-relaxed">
                Tata letak otomatis foto serah terima barang/kegiatan di kertas F4, judul, keterangan, tanggal, &amp; TTE.
              </p>
            </div>
          ...
          {/* Card: Lembar Penempelan Nota Asli */}
          <Link
            href="/user/nota"
            className="group card-hover-lift p-5 sm:p-6 bg-gradient-to-br from-slate-900 to-emerald-950/40 hover:to-emerald-900/40 border border-slate-800 hover:border-emerald-600/70 rounded-2xl shadow-xl flex flex-col justify-between gap-4"
          >
            <div>
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-xl bg-emerald-950/70 border border-emerald-700/50 text-emerald-300 flex items-center justify-center shrink-0 shadow-glow group-hover:scale-110 group-hover:rotate-1 transition-transform duration-300">
              ...
              <h3 className="text-base font-bold text-white group-hover:text-emerald-300 transition-colors mt-4">
                Lembar Tempel Nota Asli
              </h3>
              <p className="text-xs text-slate-400 mt-1.5 leading-relaxed">
                Lembar resmi kop lembaga &amp; tanda tangan Ketua &amp; Bendahara untuk menempelkan nota kontan / bon toko fisik.
              </p>
            </div>
            <div className="text-xs font-semibold text-emerald-400 flex items-center gap-1 group-hover:translate-x-1.5 transition-transform pt-2 border-t border-slate-800/80">
