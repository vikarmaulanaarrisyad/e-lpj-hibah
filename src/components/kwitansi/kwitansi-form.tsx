  ...
  const [formData, setFormData] = useState<ReceiptFormData>(() => {
    if (isPrefillFromRab) {
      ...
      return {
        ...
        template: "bank",
        kategoriRab: kategoriParam || initialRabSummary?.items?.[0]?.kode || "I",
        isPpn: false,
        isPpnIncluded: true,
        ppnRate: 0.11,
    ...
    return {
      ...
      denganMaterai: false,
      template: "bank",
      kategoriRab: initialRabSummary?.items?.[0]?.kode || "I",
      isPpn: false,
      isPpnIncluded: true,
      ppnRate: 0.11,
      ppnNominal: 0,
  ...
  const handleResetForm = (targetDateStr?: unknown) => {
    startTransition(async () => {
      ...
      setFormData({
        ...
        denganMaterai: false,
        template: "bank",
        kategoriRab: rabSummary?.items?.[0]?.kode || initialRabSummary?.items?.[0]?.kode || "I",
        isPpn: false,
        isPpnIncluded: true,
        ppnRate: 0.11,
        ppnNominal: 0,
