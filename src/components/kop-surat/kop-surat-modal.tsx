...
export function KopSuratModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-950/85 backdrop-blur-sm overflow-y-auto animate-fade-in">
      <div className="relative w-full max-w-4xl bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden my-3 sm:my-8 flex flex-col">
        {/* Header Modal */}
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] sm:text-xs text-slate-400 line-clamp-1">
                Kop surat resmi dan logo otomatis tampil pada BAST dan Kwitansi.
              </p>
            </div>
          </div>
          <button
        ...
        {/* Body Modal Form */}
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-5 sm:space-y-6 max-h-[80vh] overflow-y-auto">
          {/* ================= LIVE PREVIEW STRIP ================= */}
